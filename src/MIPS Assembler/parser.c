...
{
	int i,f, instruction;	/* The flag Instruction tells whether the current line of tokens contains an instruction*/
	uint8_t code_inst, code_sint;
	token *tok;
	token_list* cur_tk_list;
	inst_list* first_instr, *cur_instr;

	/* Initializing the lists of tokens and instructions */
