...
const inst_info inst_table[] = { 
	...
	{"bne",			TYPE_I,		STYPE_I2,	OP_BNE,			FN_BNE},
	{"slti",		TYPE_I,		STYPE_I1,	OP_SLTI,		FN_SLTI},
	{"sltiu",		TYPE_I,		STYPE_I1,	OP_SLTIU,		FN_SLTIU},
	{"lui",			TYPE_I,		STYPE_I5,	OP_LUI,			FN_LUI},
	{"lb",			TYPE_I,		STYPE_I3,	OP_LB,			FN_LB},
	{"lh",			TYPE_I,		STYPE_I3,	OP_LH,			FN_LH},
	{"lbu",			TYPE_I,		STYPE_I3,	OP_LBU,			FN_LBU},
	{"lhu",			TYPE_I,		STYPE_I3,	OP_LHU,			FN_LHU},	
	{"sb",			TYPE_I,		STYPE_I3,	OP_SB,			FN_SB},
	{"sh",			TYPE_I,		STYPE_I3,	OP_SH,			FN_SH},
	{"xori",		TYPE_I,		STYPE_I1,	OP_XORI,		FN_XORI},
};
